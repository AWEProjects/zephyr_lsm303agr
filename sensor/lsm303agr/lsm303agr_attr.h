...
#define BIT_ACC_INT_DRDY1 BIT(4)
...
#define ALLOW_BITS_ACC_INT1 (BIT_ACC_INT_CLICK | BIT_ACC_INT_AOI1 | BIT_ACC_INT_AOI2 | BIT_ACC_INT_DRDY1 | BIT_ACC_INT_FIFO_WTM | BIT_ACC_INT_FIFO_OVR)
